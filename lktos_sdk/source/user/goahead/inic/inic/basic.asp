...
function changeMCSoptions(wmode)
{
	...
	if ((document.wireless_basic.tx_stream.selectedIndex > 0) && (wmode < 12)) 
	{
		for (i = 8; i < 16; i++) 
		{
	...
	if ((document.wireless_basic.n_bandwidth[1].checked == true) && (wmode < 12))
	{
...
function insertExtChannelOption()
{
	...
	if ((1*wmode == 9) || (1*wmode == 8) || (1*wmode == 14) || (1*wmode == 15))
	{
		var x = document.getElementById("n_extcha");
...
function changeVHTBW()
{
	...
	document.getElementById("div_vht").style.visibility = "hidden";
	document.getElementById("div_vht").style.display = "none";
	document.wireless_basic.vht_bandwidth[0].disabled = true;
	document.wireless_basic.vht_bandwidth[1].disabled = true;
	if ((1*w_mode == 14) || (1*w_mode == 15))
	{
		document.getElementById("div_vht").style.visibility = "visible";
		document.getElementById("div_vht").style.display = style_display_on();
		if (document.wireless_basic.n_bandwidth[1].checked == true)
		{
