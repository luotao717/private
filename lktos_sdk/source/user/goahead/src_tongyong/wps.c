...
void WPSAPPBCStartAll(void)
{
	...
	doSystem("iwpriv ra0 set SSID=\"%s%s\"", "WPS_", nvram_bufget(RT2860_NVRAM, "SSID1"));
	doSystem("iwpriv ra0 set WscSSID=\"%s%s\"", "WPS_", nvram_bufget(RT2860_NVRAM, "SSID1"));
#endif
...
#if defined (CONFIG_LKTOS_PRIVATE_OEM_NAME_CDRKING)
	char new_ssid[64];
	sprintf(new_ssid, "WPS_%s", nvram_bufget(RT2860_NVRAM, "SSID1"));	
