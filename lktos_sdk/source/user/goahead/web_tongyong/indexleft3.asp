...
<table width="172" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td valign="top">
			<div class="column"><a href="wireless/stainfo.asp" target="mainFrame"><script>dw(MM_wireless_status)</script></a></div>
			<div class="column"><a href="wireless/basic.asp" target="mainFrame"><script>dw(MM_basic_settings)</script></a></div>
			<div class="column"><a href="wireless/macfilter.asp" target="mainFrame"><script>dw(MM_wireless_mac)</script></a></div>
			<div class="column"><a href="wireless/advanced.asp" target="mainFrame"><script>dw(MM_advanced_settings)</script></a></div>
