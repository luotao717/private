...
<form method=post name="wizard_form" action="/goform/AppApSingleSetup">
<fieldset>
...
<table width=100% border=0 cellpadding=3 cellspacing=1>
<tr id="device_name">
  <td class="thead"><script>dw(MM_devicename)</script>:</td>
  <td><input type="text" name="devicename" size="28" maxlength="64" value="<% getCfgGeneral(1, "device_name"); %>"></td>
</tr>
<tr>
