...
<table width="172" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td valign="top">
			<div class="column"><a href="usb/storage_user_admin.asp" target="mainFrame"><script>dw(MM_user)</script></a></div>
			<div class="column"><a href="usb/storage_disk_admin.asp" target="mainFrame"><script>dw(MM_disk)</script></a></div>
			<div class="column"><a href="usb/smb_srv.asp" target="mainFrame"><script>dw(MM_samba)</script></a></div>
			<div class="column"><a href="http://192.168.68.1:8099/WiDisk/" target="mainFrame"><script>dw(CHI_liulan)</script></a></div>
