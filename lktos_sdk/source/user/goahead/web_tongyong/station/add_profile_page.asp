...
<table width=100% border=0 cellpadding=3 cellspacing=1> 
  ...
  <tr>
    <td class="thead"> Fragement Threshold </td>
...
<table width=100% border=0 cellpadding=3 cellspacing=1> 
  ...
  <tr id="div_security_infra_mode"> 
    ...
    <td><select name="security_infra_mode" onChange="securityMode()">
  ...
  <tr id="div_security_adhoc_mode"> 
    <td class="thead">Security Mode</td>
    <td><select name="security_adhoc_mode" onChange="securityMode()">
	<option value=0 selected>OPEN</option>
  ...
  <tr id="div_security_encryp_mode"> 
    ...
    <td><select name="security_encryp_mode" onChange="securityMode()">
...
<table id="div_wep" width=100% border=0 cellpadding=3 cellspacing=1> 
  ...
  <tr> 
    <td class="thead" colspan="2">Default Key</td>
    <td><select name="wep_default_key" onChange="wep_default_key_switch()">
...
<table id="div_wpa" width=100% border=0 cellpadding=3 cellspacing=1> 
  ...
  <tr id="div_wpa_algorithms">
    ...
    <td><input type=radio name="cipher" value="0" checked>TKIP<input type=radio name="cipher" value="1">AES</td>
  </tr>
...
<table id="div_8021x" width=100% border=0 cellpadding=3 cellspacing=1> 
  ...
  <tr id="div_8021x_cert_from_1x">
    ...
    <td><select name="cert_auth_type_from_1x" onChange="certAuthModeChange()">
  ...
  <tr id="div_8021x_cert_from_wpa">
    <td class="thead">Authentication Type</td>
    <td><select name="cert_auth_type_from_wpa" onChange="certAuthModeChange()">
	<option value=5 selected>PEAP</option>
	<option value=6>TTLS</option>
	<option value=4>TLS</option>
      </select></td>
  ...
  <tr id="div_tunnel_auth_peap">
    ...
    <td><select name="cert_tunnel_auth_peap">
	<option value=1 selected>MSCHAP v2</option>
      </select></td>
  </tr>
  <tr id="div_tunnel_auth_ttls">
    <td class="thead">Tunnel Authentication</td>
    <td><select name="cert_tunnel_auth_ttls">
  ...
  <tr id="div_client_cert_path">
    ...
    <td><select name="cert_client_cert_path">
      ...
      <input type="button" value="Install" name="ca_cl_cert_upload" onClick="open_cert_upload('client')"></td>
  </tr>
  <tr id="div_private_key_path">
    ...
    <td><select name="cert_private_key_path">
      ...
      <input type="button" value="Install" name="key_cert_upload" onClick="open_cert_upload('key')"></td>
  </tr>
