...
<frameset rows="100,*" cols="*" frameborder="no" border="0" framespacing="0">
  ...
  <frameset cols="172,32,*" frameborder="no" border="0" framespacing="0">
  	<frame src="indexleft5.asp" name="leftFrame" scrolling="auto" noresize="noresize" id="leftFrame" title="leftFrame" />
    <frame src="arc.html" name="arcFrame" scrolling="No" noresize="noresize" id="arcFrame" title="arcFrame" />
	<frame src="usb/storage_user_admin.asp" name="mainFrame" id="mainFrame" title="mainFrame" />	  
</frameset></frameset>
<noframes><body>
</body>
