...
<table width="172" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td valign="top">
			<div class="column"><a href="firewall/system_firewall.asp" target="mainFrame"><script>dw(MM_sys_firewall)</script></a></div>
			<div class="column"><a href="firewall/port_filtering.asp" target="mainFrame"><script>dw(MM_ipportf)</script></a></div>
			<div class="column"><a href="firewall/url_filtering.asp" target="mainFrame"><script>dw(MM_urlf)</script></a></div>
