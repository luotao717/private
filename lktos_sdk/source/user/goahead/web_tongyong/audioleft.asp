...
<table width="172" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td valign="top">
			<div class="column"><a href="adm/wizard.asp" target="mainFrame"><script>dw(MM_network)</script></a></div>
			<div class="column"><a href="wireless/apcli.asp" target="mainFrame"><script>dw(MM_audio_1)</script></a></div>
          <div class="column"><a href="adm/upload_firmware.asp" target="mainFrame" onClick="Echange(this,0)"><script>dw(MM_management)</script></a></div>
