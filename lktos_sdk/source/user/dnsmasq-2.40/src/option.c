...
#define OPTSTRING "9531yZUDNLERKzuowefnbvhdkqr:m:p:c:l:s:i:t:g:a:x:S:C:A:T:H:Q:I:B:F:G:O:M:X:V:j:P:J:W:Y:2:4:6:7:8:0:"
...
static const struct optflags optmap[] = {
  ...
  { 'n',            OPT_NO_POLL },
  { 'd',            OPT_DEBUG },
  { 'u',           OPT_DNSSPOOF_MODE1 },
  { 'U',            OPT_DNSSPOOF_MODE2 },
  { 'k',            OPT_NO_FORK },
  { 'K',            OPT_AUTHORITATIVE },
  { 'o',            OPT_ORDER },
  { 'R',            OPT_NO_RESOLV },
