...
#mv
wiimu_hardware=`cat /system/workdir/MVver | grep WiiMu-A01`
if [ "$wiimu_hardware" = "WiiMu-A01" ]; then
#a01
cd /system/workdir
reg s 0
reg m 60 1 0 1
...
reg m 24 0 1 1
wiimu_var1=`reg p 20`
wiimu_var2=$(($wiimu_var1 & 0x2))

if [ "$wiimu_var2" = "0" ]; then
echo "invoke factory.sh"
./factory.sh
else
reg m 24 1 1 1
./live.sh	
