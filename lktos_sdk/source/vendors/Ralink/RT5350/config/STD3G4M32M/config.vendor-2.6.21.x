...
CONFIG_USER_DDNS=y
CONFIG_USER_PPPOE_SPECDIALING=y
CONFIG_USER_MACPASSTHROUGH=y
...
#
# Lktos private oem product name
#
CONFIG_LKTOS_PRIVATE_OEM_NAME_ORIGINAL=y
# CONFIG_LKTOS_PRIVATE_OEM_NAME_TOTOLINK is not set
# CONFIG_LKTOS_PRIVATE_OEM_NAME_TONGYONG is not set
