...
# CONFIG_USER_APPINTERFACE is not set
...
#
CONFIG_LKTOS_INITCONFIG_TOOLS=y

#
# Lktos Private OEM Product
#
# CONFIG_LKTOS_PRIVATE_OEM_NAME_ORIGINAL is not set
# CONFIG_LKTOS_PRIVATE_OEM_NAME_TOTOLINK is not set
CONFIG_LKTOS_PRIVATE_OEM_NAME_TONGYONG=y
# CONFIG_LKTOS_PRIVATE_OEM_NAME_CARY is not set
# CONFIG_LKTOS_PRIVATE_OEM_NAME_CDRKING is not set
# CONFIG_LKTOS_PRIVATE_OEM_NAME_NBOX is not set
CONFIG_USER_LANG_ALL=y
# CONFIG_USER_LANG_CN is not set
# CONFIG_USER_LANG_EN is not set
# CONFIG_USER_LANG_PT is not set
